...
public class UnityChanPlayer : MonoBehaviour
{
    ...
    public UnityChanMovement mPlayerMovement;
    ...
    void Start()
    {
        mFsm.Add(new UnityChanState_MOVEMENT(this));
        mFsm.Add(new UnityChanState_ATTACK(this));
        mFsm.Add(new UnityChanState_RELOAD(this));
